...
This project presents a machine learning–based framework for **short-term arrival delay time prediction in freight rail operations**. By leveraging historical operational data, the system models delay patterns and propagation effects to improve arrival time reliability and support data-driven operational planning.
...
* Support decision-making in freight rail transportation systems
...
3. **Model Development**
   ...
   * Performance evaluation using appropriate regression metrics
